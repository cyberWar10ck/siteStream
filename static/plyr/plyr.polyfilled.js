  ...
  (function (e, t) {
    ...
    const Me = {
      ...
      createIcon(e, t) {
        ...
        I(a, L(t, { "aria-hidden": "true", focusable: "false" }));
      ...
      createButton(e, t) {
        ...
        return (
          ...
          L(i, q(this.config.selectors.buttons[s], i)),
          I(a, i),
          "play" === s
          ...
          ne(A.array(this.config.controls) ? this.config.controls : []).forEach(
            (r) => {
              ...
              if (
                ...
                if (
                  ((A.element(t) && c.contains(t)) ||
                    ((t = O(
                      "div",
                      L({}, u, { class: `${u.class} plyr__volume`.trim() })
                    )),
                  ...
                  t.appendChild(
                    n.call(this, "volume", L(i, { id: `plyr-volume-${e.id}` }))
                  );
                }
              }
              if (
                ...
                r.appendChild(o),
                  ...
                  this.config.settings.forEach((i) => {
                    const s = O(
                      "button",
                      L(q(this.config.selectors.buttons.settings), {
                        type: "button",
              ...
              if (
                ...
                !A.url(t) &&
                  this.isEmbed &&
                  L(e, { icon: `logo-${this.provider}`, label: this.provider }),
              ...
              "focusout" !== n &&
                (this.focusTimer = setTimeout(() => {
                  ...
                  i.container.contains(e) &&
                    F(document.activeElement, t.config.classNames.tabFocus, !0);
                }, 10)));
          }),
          t(this, "global", (e = !0) => {
            const { player: t } = this;
